...
| `conformance/flop/rule-registry.json` | thirty-one rules at the 2026-09-14 snapshot, twenty-four `official-draft`, seven `unknown` | quoted, hashed, marked stale when the source moves (`docs/FLOP_RULE_REGISTRY.md`) |
